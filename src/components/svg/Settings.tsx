...
export default function Search({className} : SvgProps) {
    return (
        <svg className={className || ''} fill="#000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
        width="800px" height="800px" viewBox="0 0 48.4 48.4" xmlSpace="preserve">
   <g>
